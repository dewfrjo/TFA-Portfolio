...
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger, gsap_Draggable__WEBPACK_IMPORTED_MODULE_2__.Draggable);
...
document.querySelectorAll('.passion').forEach(function (passion) {
  passion.addEventListener('mouseover', function () {
    var rotation = Math.random() * 12 - 6; // Rotation aléatoire entre -6 et 6 degrés
    var backText = this.querySelector('.bricoler__back, .jeu__back, .rando__back, .moto__back, .dessin__back');
    backText.style.transform = "translateX(-50%) rotate(".concat(rotation, "deg)");
  });
...
document.querySelectorAll('.passion').forEach(function (passion) {
  passion.addEventListener('mouseover', function () {
    if (window.innerWidth >= 1024) {
      // Vérifie si la largeur de l'écran est au moins de 1024 pixels (version PC)
      var rotation = Math.random() * 12 - 6; // Rotation aléatoire entre -6 et 6 degrés
      var backText = this.querySelector('.bricoler__back, .jeu__back, .rando__back, .moto__back, .dessin__back');
      backText.style.transform = "translateX(-50%) rotate(".concat(rotation, "deg)");
    }
...
var btnPassions = document.querySelectorAll('.btn');
var textPassions = document.querySelectorAll('.passion__text__mob');

// Ajoutez un écouteur d'événements à chaque bouton
btnPassions.forEach(function (btn, index) {
  btn.addEventListener('click', function () {
    // Utilisez l'index pour trouver le paragraphe correspondant
    var textPassion = textPassions[index];
    if (window.innerWidth < 1024) {
      // Vérifie si la largeur de l'écran est inférieure à 1024 pixels (version mobile)
...
function runYourCode() {
  ...
  if (title) {
    var titleTypeWriter = function titleTypeWriter() {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunk_dwmaj_workflow_php"] = self["webpackChunk_dwmaj_workflow_php"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["assets/styles/app"], () => (__webpack_require__("./src/scripts/app.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["assets/styles/app"], () => (__webpack_require__("./src/styles/app.scss")))
